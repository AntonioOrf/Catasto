  ...
  return (
    <div className="min-h-screen flex flex-col bg-bg-main text-text-main font-serif">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full p-6 md:p-10">
        ...
        <div className="bg-bg-dark border border-border-color rounded-lg p-6 shadow-lg mb-8">
          <h3 className="text-xl font-bold mb-4 text-text-muted">Progetto Catasto</h3>
