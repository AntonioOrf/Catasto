...
export default function CatastoTable({
    ...
    const renderSortIcon = (columnKey) => {
        ...
        if (sortBy !== columnKey) return <ArrowUpDown className="h-4 w-4 text-text-accent opacity-30 ml-1" />;
    ...
    const thClasses = "bg-color-border-base px-3 py-3 md:px-6 md:py-4 text-left text-xs font-bold text-text-accent uppercase tracking-wider font-sans cursor-pointer hover:bg-item-hover/10 group transition-colors";
    ...
    return (
        <div className="space-y-4 pb-12">
            ...
            {error ? (
                <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-800 p-4 text-red-900 dark:text-red-200 font-serif">
