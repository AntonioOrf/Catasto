...
export default function FilterPanel({
    ...
    // Classi base per gli input per evitare ripetizioni e garantire consistenza
    ...
    return (
        // CONTENITORE PRINCIPALE: Usa bg-bg-sidebar per staccare leggermente dallo sfondo della pagina (bg-bg-main)
        <div className="bg-bg-sidebar rounded-sm shadow-lg border border-border-base mb-6 relative overflow-hidden transition-colors duration-300">

            {/* GRADIENTE SUPERIORE: Usa i colori dell'header e dell'accento */}
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-bg-header to-text-accent"></div>

            <div className="p-4 md:p-6">

                {/* --- RIGA DI RICERCA PRINCIPALE --- */}
                    ...
                    <div className="bg-bg-main border border-border-base rounded p-3 md:p-4 mt-2 transition-all duration-300 animate-in slide-in-from-top-2">
                        ...
                        <div className="border-t border-border-base pt-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                                {/* Helper component per i range per pulire il codice */}
...
// Piccolo componente interno per evitare ripetizioni
